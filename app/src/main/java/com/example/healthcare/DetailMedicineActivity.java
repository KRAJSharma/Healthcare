...
public class DetailMedicineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvpackagename=findViewById(R.id.titleDMTitle);
        tvtotalcost=findViewById(R.id.textViewDMTotalCost);
        eddetails=findViewById(R.id.EditTextMultiline);
        btn=findViewById(R.id.buttonDMBack);
        btn2=findViewById(R.id.buttonDMGotoCart);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(DetailMedicineActivity.this,BuyMedicineActivity.class));
            }
        });
